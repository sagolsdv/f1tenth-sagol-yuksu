...
from rl_tf.car_control import Drive
from rl_tf.safety_control import SafetyControl
from rl_tf.sensors import Sensors
...
class CarEnv(Node):
    ...
    def _get_car_state(self):
        if not self.sensors.get_lidar_ranges():
            return []
